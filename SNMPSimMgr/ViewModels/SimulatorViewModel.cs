...
namespace SNMPSimMgr.ViewModels
{
    public partial class SimulatorViewModel : ObservableObject
    {
        ...
        private readonly ConcurrentDictionary<string, SnmpSimulatorService>  _simulators = new ConcurrentDictionary<string, SnmpSimulatorService>();
        ...
        public ObservableCollection<SimulatorDeviceStatus>  ActiveSimulators { get; } = new ObservableCollection<SimulatorDeviceStatus>();
        public ObservableCollection<string>  TrafficLog { get; } = new ObservableCollection<string>();
        public ObservableCollection<QueryResultItem>  QueryResults { get; } = new ObservableCollection<QueryResultItem>();
        ...
        [RelayCommand]
        private void ToggleTrafficPause()
        {
