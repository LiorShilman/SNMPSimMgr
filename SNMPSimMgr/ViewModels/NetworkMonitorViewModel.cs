...
namespace SNMPSimMgr.ViewModels
{
    public partial class NetworkMonitorViewModel : ObservableObject
    {
        ...
        public ObservableCollection<ClientConnection>  Connections { get; } = new ObservableCollection<ClientConnection>();
        public ObservableCollection<TrafficEntry>  TrafficEntries { get; } = new ObservableCollection<TrafficEntry>();
