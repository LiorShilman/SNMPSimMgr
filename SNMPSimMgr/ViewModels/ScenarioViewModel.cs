...
namespace SNMPSimMgr.ViewModels
{
    public partial class ScenarioViewModel : ObservableObject
    {
        ...
        public ObservableCollection<ScenarioEvent>  Events { get; } = new ObservableCollection<ScenarioEvent>();
        ...
        // Presets
        public ObservableCollection<string>  ValueTypes { get; } = new ObservableCollection<string>() {
