...
public class MibPanelExportService
{
    ...
    private readonly DeviceProfileStore _deviceStore;
    ...
    private static readonly Dictionary<string, string[]> LabelColumnPreference = new()
    {
    ...
    public MibPanelExportService(MibStore mibStore, DeviceProfileStore deviceStore)
    {
        _mibStore = mibStore;
